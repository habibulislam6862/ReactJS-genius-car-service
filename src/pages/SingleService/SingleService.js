...
const SingleService = () => {
  ...
  return (
    <article className="mt-5">
      ...
      <button className="btn btn-outline-danger ms-3" onClick={handleDelete}>
        Delete
      </button>
      {loading ? (
        <Spinner />
        ...
        <>
          ...
          <p>{fullDescription}</p>
          <h2>
            <span className="text-danger">Only</span> ${price}
          </h2>
